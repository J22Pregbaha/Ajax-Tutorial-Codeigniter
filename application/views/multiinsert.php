...
<script>
	$(document).ready(function(){
		...
		$(document).on('click', '.add', function(){
			...
			html += '<td><select name="item_unit[]" class="form-control item_unit"><option value="">Select Unit</option><?php echo $fill_box; ?></select></td>';
		...
		$('#insert_form').on('submit', function(event){
			...
			{
				$.ajax({
					url:'<?php echo base_url('multiinsert/insert'); ?>',
					method:"POST",
					data:form_data,
