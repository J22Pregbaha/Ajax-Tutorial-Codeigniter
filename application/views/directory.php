...
<body>
	<div class="container box">
		<br />
		<h2 align="center">Directory of AJAX applications</h2><br />
		<button type="button" class="btn btn-primary" onclick="window.location.href='<?php echo base_url(); ?>multiform'">Multiple forms in one page</button>
